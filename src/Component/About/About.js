                ...
                <div className="about-items">
                    <div className="about-left">
                        <div className="about-detail">
                            ...
                            <p>DLF Jogeshwari Andheri West , Mumbai is a brand newly launched ultra-luxury residences that offer lavish 2 BHK and 3 BHK homes with futuristic measures and modern features. The project is helmed by the notable real estate developer DLF Group with an aim to provide lavish living space for the discerning elite few.</p>
